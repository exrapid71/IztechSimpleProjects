...
public class Des {
	...
	// First index is garbage value, loops operating on this should start with index
	// = 1
	...
	private static int[] g = { 32, 1, 2, 3, 4, 5, 4, 5, 6, 7, 8, 9, 8, 9, 10, 11, 12, 13, 12, 13, 14, 15, 16, 17, 16,
	...
	static int[] IPi = { 40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47, 15, 55, 23, 63, 31, 38, 6, 46, 14, 54, 22, 62, 30,
	 ...
	 * 
	 * @param key
	 *            : String - the key to decrypt with
	 * @param plaintext
	 *            : String - Hex string to decrypt
	 ...
	 * 
	 * @param mi
	 *            : String - 32-bit message binary string
	 * @param key
	 *            : String - 48-bit key binary string
	...
	public static void run() {
		...
		System.out.println("3Des is Start To Run");
		Des des = new Des();
		new DH().init();
		boolean enc = true;
		String key1 = null, key2 = null, key3 = null, message = null, result = null;
		message = "Des Test";
		key1 = "98180775 c88b3e3f ba460294 69edbd79 29fe596e 63fb8ab7 0966a0bc 22a3ca6a"
				+ "    b6296910 8cd2c4b5 42600acd 993c57ce 560f12ca 3b493aee edf34f50 54785cd1"
				+ "    01d3d7a1 25769649 0634c91e 5380a02a 1b2a7c07 efbef804 9ba11227 9e3265f4"
				+ "    6c43bb32 a4c5a8aa 68dd065f c23f4df6 c85f6726 ecb42b25 bfda51ef f97bf8bd";
		key2 = "fd7f5381 1d751229 52df4a9c 2eece4e7 f611b752 3cef4400 c31e3f80 b6512669"
				+ "    455d4022 51fb593d 8d58fabf c5f5ba30 f6cb9b55 6cd7813b 801d346f f26660b7"
				+ "    6b9950a5 a49f9fe8 047b1022 c24fbba9 d7feb7c6 1bf83b57 e7c6a8a6 150f04fb"
				+ "    83f6d3c5 1ec30235 54135a16 9132f675 f3ae2b61 d72aeff2 2203199d d14801c7";
		key3 = "f7e1a085 d69b3dde cbbcab5c 36b857b9 7994afbb fa3aea82 f9574c0b 3d078267"
